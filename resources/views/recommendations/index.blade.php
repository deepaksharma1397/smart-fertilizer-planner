    ...
    <table class="w-full border-collapse">
        ...
        <tbody>
            ...
            <tr class="border-b hover:bg-gray-100">
                ...
                <td class="p-3">{{ $recommendation->farmer_name }}</td>
                <td class="p-3">{{ $recommendation->crop_type }}</td>
                <td class="p-3">{{ $recommendation->soil_type }}</td>
                <td class="p-3">{{ $recommendation->nitrogen }}</td>
                <td class="p-3">{{ $recommendation->phosphorus }}</td>
                <td class="p-3">{{ $recommendation->potassium }}</td>
